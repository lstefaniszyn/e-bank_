...
public class BFLoggerInstance {
	...
	/**
	 * WARNING: Do not use this method outside of BaseTestWatcher Begin writing all logs to a separate file in addition
	...
	/**
	 * WARNING: Do not use this method outside of BaseTestWatcher Stop writing to the separate log file, return its
