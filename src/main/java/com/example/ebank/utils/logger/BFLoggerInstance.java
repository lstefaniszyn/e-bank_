...
public class BFLoggerInstance {
    ...
    /**
     * WARNING: Do not use this method outside of BaseTestWatcher Begin writing all
    ...
    /**
     * WARNING: Do not use this method outside of BaseTestWatcher Stop writing to
     * the separate log file, return its current content and clear the file
     *
     * @return
     */
    protected String dumpSeparateLog() {
        try {
            return Files.asCharSource(getLogFile(), Charsets.UTF_8).read();
        } catch (IOException e) {
            e.printStackTrace();
            return "";
        }
