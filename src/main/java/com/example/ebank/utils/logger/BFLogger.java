...
public class BFLogger {
    ...
    /**
     * This inner class contains methods that should not be used unless directly
    ...
    public static class RestrictedMethods {
        ...
        /**
         * WARING: Do not use this method outside of BaseTestWatcher Begin writing all
         * logs to a separate file in addition to the main log file
         */
        ...
        /**
         * WARING: Do not use this method outside of BaseTestWatcher Stop writing to the
         * separate log file, return its current content and clear the file
         *
         * @return
         */
